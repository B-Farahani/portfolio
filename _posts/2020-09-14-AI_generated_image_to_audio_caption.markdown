...
Below are a few examples of the captions generated by the model. I have converted them to speech and will add the audio here soon!

![Little_boy_in_red](../assets/img/image_captions/Little_boy_in_red.jpg){: .postImage}

[Audio Caption](../assets/img/image_captions/boy_in_red.mp3){: .postImage}

"a child in a red coat is climbing a snowy hill"{: .postImage}
